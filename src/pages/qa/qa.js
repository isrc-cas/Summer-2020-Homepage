...
const qa = [
    ...
    },
    {
        ...
        a:[
            {
                con:`1. 社区应在社区官网（或项目对外公开仓库） 上线 “暑期2020” 页面或活动说明（html、wiki 等方式不限），内容包括本社区/项目组提供的所有项目任务详情清单，以及配套的参考材料；在活动官网（<a href="https://isrc.iscas.ac.cn/summer2020">isrc.iscas.ac.cn/summer2020</a>）会上线社区介绍信息，并提供链接跳转到该社区的活动说明页面；所有项目列表会同步在活动官网上线，但以社区页面上的项目详细信息为准。`,
            },
            {
                con: `2. 社区应按附：<a download="社区项目模板.md" href=${cp}>社区项目模板</a>提供社区介绍信息、预估开发工作量是 3 个月的项目任务信息及其对应的参考材料。`,
            },
            {
                con:`3. 社区针对每个项目指定一名导师，一般应是该项目相关的开发者（maintainer、commitor、contributor），负责：`,
                conlist:[
